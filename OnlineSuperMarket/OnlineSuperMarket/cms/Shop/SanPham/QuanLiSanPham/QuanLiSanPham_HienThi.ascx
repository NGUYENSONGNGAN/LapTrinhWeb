<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="QuanLiSanPham_HienThi.ascx.cs" Inherits="OnlineSuperMarket.cms.Shop.SanPham.QuanLiSanPham.QuanLiSanPham_HienThi" %>
<div class="head">
    Các sản phẩm đã tạo. 
    <div class="fr ter"><a class="btThemMoi" href="/Shop.aspx?modul=SanPham&modulphu=SanPham&thaotac=ThemMoi">Thêm mới sản phẩm</a></div>
    <div class="cb"></div>
</div>
