<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="HoaDon_HienThi.ascx.cs" Inherits="OnlineSuperMarket.cms.Shop.HoaDon.HoaDon_HienThi" %>
<div class="head">
    Danh sách đơn hàng
    <div class="cb"></div>
</div>
