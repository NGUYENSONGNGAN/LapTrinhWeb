<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DanhMuc_ThemMoi.ascx.cs" Inherits="OnlineSuperMarket.cms.display.DangTin.QuanLiDanhMuc.DanhMuc_ThemMoi" %>
<div class="head">
