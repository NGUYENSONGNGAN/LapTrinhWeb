...
namespace OnlineSuperMarket.cms.display.DangTin
{
    public partial class DangTinLoadControl : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            switch (modulphu)
            {
                ...
                case "DanhSachSanPham":
                    plSanPhamLoadControl.Controls.Add(LoadControl("QuanLiSanPham/SanPhamLoadControl.ascx"));
                    break;


                case "NhomSanPham":
                    plSanPhamLoadControl.Controls.Add(LoadControl("QuanLiNhomSanPham/NhomLoadControl.ascx"));
                    break;
