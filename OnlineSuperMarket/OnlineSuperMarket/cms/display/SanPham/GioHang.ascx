<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GioHang.ascx.cs" Inherits="OnlineSuperMarket.cms.display.SanPham.GioHang" %>
    ...
    <div>
        ...
        <div class="modal-footer">
            <div class="dienThongTinDatHang">
                <div class="goiY">Quý khách vui lòng điền đầy đủ thông tin theo form phía dưới và nhấn nút Liên hệ.<br/>Lưu ý: Nếu quý khách điền vào ô Email thì hệ thống sẽ kiểm tra và tạo cho quý khách một tài khoản thành viên với tên đăng nhập và mật khẩu chính là email của quý khách để quý khách có thể liên hệ dễ dàng hơn ở lần sau.</div>
                <div class="row">
                    <div class="col-lg-3">
            ...
            <div class="row" style="margin-top:10px;">
                <div class="col-lg-6">
                    <div class="comeback">
                        <a href="/">
                            <img src="../pic/dangnhap/icon-tieptuc.png" />  Tiếp tục xem tin
                        </a>
                    </div>
                </div>
