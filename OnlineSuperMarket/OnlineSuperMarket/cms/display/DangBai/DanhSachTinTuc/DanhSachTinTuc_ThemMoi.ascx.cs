    ...
    public partial class DanhSachTinTuc_ThemMoi : System.Web.UI.UserControl
    {
        ...
        private void HienThiThongTin(string id)
        {
            if (thaotac == "ChinhSua")
            {
                ...
                dt = OnlineSuperMarket.DataBase.TinTuc.Thongtin_Tintuc_by_id(id);
                if (dt.Rows.Count > 0)
                {
        ...
        protected void btThemMoi_Click(object sender, EventArgs e)
        {
            if (thaotac == "ThemMoi")
            {
                ...
                OnlineSuperMarket.DataBase.TinTuc.TinTuc_Inser(
                ...
                else
                {
                    ...
                    Response.Redirect("Default.aspx?modul=DangBai&modulphu=DanhSachTinTuc");
                }
                #endregion
            }
            else
            {
                ...
                OnlineSuperMarket.DataBase.TinTuc.TinTuc_Update(
