<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DanhSachTinTuc_ThemMoi.ascx.cs" Inherits="OnlineSuperMarket.cms.display.DangBai.DanhSachTinTuc.DanhSachTinTuc_ThemMoi" %>
