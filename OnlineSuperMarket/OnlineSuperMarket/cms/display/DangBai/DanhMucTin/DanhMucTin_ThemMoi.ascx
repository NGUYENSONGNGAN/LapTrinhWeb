<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DanhMucTin_ThemMoi.ascx.cs" Inherits="OnlineSuperMarket.cms.display.DangBai.DanhMucTin.DanhMucTin_ThemMoi" %>
