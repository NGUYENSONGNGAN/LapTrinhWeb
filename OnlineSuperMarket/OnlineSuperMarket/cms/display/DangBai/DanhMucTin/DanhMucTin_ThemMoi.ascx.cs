...
namespace OnlineSuperMarket.cms.display.DangBai.DanhMucTin
{
    public partial class DanhMucTin_ThemMoi : System.Web.UI.UserControl
    {
        ...
        private void HienThiThongTin(string id)
        {
            if (thaotac == "ChinhSua")
            {
                ...
                dt = OnlineSuperMarket.DataBase.DanhMucTin.Thongtin_DanhmucTin_by_id(id);
                if (dt.Rows.Count > 0)
                {
        ...
        {
            DataTable dt = new DataTable();
            dt = OnlineSuperMarket.DataBase.DanhMucTin.Thongtin_DanhmucTin_by_MaDMCha(MaDMCha);
        ...
        protected void btThemMoi_Click(object sender, EventArgs e)
        {
            if (thaotac == "ThemMoi")
            {
                ...
                OnlineSuperMarket.DataBase.DanhMucTin.DanhmucTin_Inser(tbTenDanhMuc.Text, flAnhDaiDien.FileName, tbThuTu.Text, ddlDanhMucCha.SelectedValue, "");
                ...
                else
                {
                    ...
                    Response.Redirect("Default.aspx?modul=DangBai&modulphu=DanhMucTin");
                }
                #endregion
            }
            else
            {
                ...
                OnlineSuperMarket.DataBase.DanhMucTin.DanhmucTin_Update(id, tbTenDanhMuc.Text, flAnhDaiDien.FileName, tbThuTu.Text, ddlDanhMucCha.SelectedValue);
