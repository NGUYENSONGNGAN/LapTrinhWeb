<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DangKy.ascx.cs" Inherits="OnlineSuperMarket.cms.display.ThanhVien.DangKy" %>
    ...
    <div id="create_customer">
        ...
        <div id="first_name" class="clearfix">
            <div class="label-fname"></div>
               ...
               <asp:TextBox ID="tbHoTen" runat="server" CssClass="text" placeholder="Họ tên" OnTextChanged="tbHoTen_TextChanged"></asp:TextBox>
        ...
        <%--checkbock--%>
          ...
          <input id="rbdangnhap" type="radio" name="rbHinhThucDangNhap"/><label for="rbDangNhap">Đăng kí Shop</label>
          <input id="rbdangnhap" type="radio" name="rbHinhThucDangNhap"/><label for="rbDangNhap">Đăng kí khách hàng</label>
