...
namespace OnlineSuperMarket.cms.display
{
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            switch (modul)
            {
                ...
                case "TinTuc":
                    ...
                    break;
                case "DangBai":
                    plLoadControl.Controls.Add(LoadControl("DangBai/DangBaiLoadControl.ascx"));
                    break;

                case "DangTin":
                    plLoadControl.Controls.Add(LoadControl("DangTin/DangTinLoadControl.ascx"));
                    break;
