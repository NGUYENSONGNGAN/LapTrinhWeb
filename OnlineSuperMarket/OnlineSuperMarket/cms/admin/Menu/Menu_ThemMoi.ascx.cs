    ...
    public partial class Menu_ThemMoi : System.Web.UI.UserControl
    {
        ...
        private void HienThiThongTin(string id)
        {
            if (thaotac == "ChinhSua")
            {
                ...
                dt = OnlineSuperMarket.DataBase.Menu.Thongtin_Menu_by_id(id);
                if (dt.Rows.Count > 0)
                {
        ...
        {
            DataTable dt = new DataTable();
            dt = OnlineSuperMarket.DataBase.Menu.Thongtin_Menu_by_MaMenuCha(MaMenuCha);
        ...
        protected void btThemMoi_Click(object sender, EventArgs e)
        {
            if (thaotac == "ThemMoi")
            {
                ...
                OnlineSuperMarket.DataBase.Menu.Menu_Inser(
                ...
                else
                {
                    ...
                    Response.Redirect("Admin.aspx?module=Menu&modulephu=DanhSachMenu");
                }
                #endregion
            }
            else
            {
                ...
                OnlineSuperMarket.DataBase.Menu.Menu_Update(id, tbTenMenu.Text, tbLienKet.Text,
                    ddlMenuCha.SelectedValue, tbThuTu.Text);
