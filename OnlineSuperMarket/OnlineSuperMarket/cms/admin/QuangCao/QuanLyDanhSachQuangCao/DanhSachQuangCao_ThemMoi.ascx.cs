    ...
    public partial class DanhSachQuangCao_ThemMoi : System.Web.UI.UserControl
    {
        ...
        private void HienThiThongTin(string id)
        {
            if (thaotac == "ChinhSua")
            {
                ...
                dt = OnlineSuperMarket.DataBase.QuangCao.Thongtin_Quangcao_by_id(id);
                if (dt.Rows.Count > 0)
                {
                    ddlDanhMucCha.SelectedValue = dt.Rows[0]["MaQuangCao"].ToString();
        ...
        private void LayNhom()
        {
            ...
            {
                ddlDanhMucCha.Items.Add(new ListItem(dt.Rows[i]["TenNhomQuangCao"].ToString(), dt.Rows[i]["MaNhomQuangCao"].ToString()));
        ...
        protected void btThemMoi_Click(object sender, EventArgs e)
        {
            if (thaotac == "ThemMoi")
            {
                ...
                OnlineSuperMarket.DataBase.QuangCao.Quangcao_Inser(
                ...
                else
                {
                    ...
                    Response.Redirect("Admin.aspx?module=QuangCao&modulephu=DanhSachQuangCao");
                }
                #endregion
            }
            else
            {
                ...
                OnlineSuperMarket.DataBase.QuangCao.quangcao_update(
