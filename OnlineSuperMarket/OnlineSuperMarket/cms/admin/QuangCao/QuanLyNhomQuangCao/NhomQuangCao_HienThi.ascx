<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="NhomQuangCao_HienThi.ascx.cs" Inherits="OnlineSuperMarket.cms.admin.QuangCao.QuanLyNhomQuangCao.NhomQuangCao_HienThi" %>

<div class="head">
    Các nhóm quảng cáo đã tạo. 
    <div class="fr ter"><a class="btThemMoi" href="/Admin.aspx?module=QuangCao&modulephu=NhomQuangCao&thaotac=ThemMoi">Thêm mới nhóm quảng cáo</a></div>
    <div class="cb"></div>
</div>
...
<script type="text/javascript">
    function XoaNhomQuangCao(NhomQuangCaoID) {
        if (confirm("Bạn chắc chắn muốn xóa nhóm quảng cáo này")) {
