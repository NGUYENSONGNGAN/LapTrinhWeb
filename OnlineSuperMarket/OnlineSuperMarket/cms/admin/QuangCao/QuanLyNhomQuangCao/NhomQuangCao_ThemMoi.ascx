<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="NhomQuangCao_ThemMoi.ascx.cs" Inherits="OnlineSuperMarket.cms.admin.QuangCao.QuanLyNhomQuangCao.NhomQuangCao_ThemMoi" %>
...
<div class="FormThemMoi">
    ...
    <div class="thongTin">
        ...
        <div class="oNhap">
            ...
            <asp:Button ID="btHuy" runat="server" Text="Hủy" CssClass="btHuy" OnClick="btHuy_Click" CausesValidation="false" style="height: 26px" />
        </div>
    </div>
</div>