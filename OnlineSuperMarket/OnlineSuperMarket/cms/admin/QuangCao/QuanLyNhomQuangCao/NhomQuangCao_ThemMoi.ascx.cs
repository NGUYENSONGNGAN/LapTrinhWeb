    ...
    public partial class NhomQuangCao_ThemMoi : System.Web.UI.UserControl
    {
        ...
        private void HienThiThongTin(string id)
        {
            if (thaotac == "ChinhSua")
            {
                ...
                dt = OnlineSuperMarket.DataBase.NhomQuangCao.Thongtin_Nhomquangcao_by_id(id);
                if (dt.Rows.Count > 0)
                {
        ...
        protected void btThemMoi_Click(object sender, EventArgs e)
        {
            if (thaotac == "ThemMoi")
            {
                ...
                OnlineSuperMarket.DataBase.NhomQuangCao.Nhomquangcao_Inser(tbTenNhomQC.Text, tbViTriQC.Text, tbThuTu.Text, flAnhDaiDien.FileName, "");
                ...
                else
                {
                    ...
                    Response.Redirect("Admin.aspx?module=QuangCao&modulephu=NhomQuangCao");
                }
                #endregion
            }
            else
            {
                ...
                OnlineSuperMarket.DataBase.NhomQuangCao.Nhomquangcao_Update(id, tbTenNhomQC.Text, tbViTriQC.Text, tbThuTu.Text, flAnhDaiDien.FileName);
