...
namespace OnlineSuperMarket
{
    public partial class Login : System.Web.UI.Page
    {
        ...
        protected void lbtDangNhap_Click(object sender, EventArgs e)
        {
            ...
            DataTable dt = OnlineSuperMarket.DataBase.DangKy.Thongtin_DangKy_by_id_matkhau(tbTenDangNhap.Text,
                OnlineSuperMarket.DataBase.MaHoa.MaHoaMD5(tbMatKhau.Text));
            if (dt.Rows.Count > 0)
            {
                ...
                Session["TenDangNhap"] = dt.Rows[0]["TaiKhoan"];
